...
IF SERVERPROPERTY('EngineEdition') != 5
    SET @SQL += N'USE master;' + @CrLf + @CrLf
          + N'IF EXISTS(SELECT 1 FROM sys.databases WHERE name = N''$(DatabaseName)'')' + @CrLf
          + N'BEGIN' + @CrLf
          + N'    ALTER DATABASE [$(DatabaseName)] SET SINGLE_USER WITH ROLLBACK IMMEDIATE;' + @CrLf
          + N'    DROP DATABASE [$(DatabaseName)];' + @CrLf
          + N'END;' + @CrLf + @GO
          + N'CREATE DATABASE [$(DatabaseName)]' + @CrLf
          + N'ON PRIMARY' + @CrLf
          + N'( ' + @CrLf
          + N'    NAME = WWI_Primary,' + @CrLf
          + N'    FILENAME = ''' + @SQLDataFolder + N'$(DefaultFilePrefix).mdf'',' + @CrLf
          + N'    SIZE = 1GB,' + @CrLf
          ...
          + N'    FILENAME = ''' + @SQLDataFolder + N'$(DefaultFilePrefix)_UserData.ndf'',' + @CrLf
          + N'    SIZE = 2GB,' + @CrLf
          + N'    MAXSIZE = UNLIMITED,' + @CrLf
          + N'    FILEGROWTH = 64MB' + @CrLf
          + N')' + @CrLf
          ...
          + N'(' + @CrLf
          + N'    NAME = WWI_Log,' + @CrLf
          + N'    FILENAME = ''' + @SQLLogFolder + N'$(DefaultFilePrefix).ldf'',' + @CrLf
          + N'    SIZE = 100MB,' + @CrLf
          + N'    MAXSIZE = UNLIMITED,' + @CrLf
          + N'    FILEGROWTH = 64MB' + @CrLf
          + N');' + @CrLf + @GO
          + N'ALTER AUTHORIZATION ON DATABASE::[$(DatabaseName)] to sa;' + @CrLf + @GO
          + N'USE [$(DatabaseName)];' + @CrLf + @GO;
