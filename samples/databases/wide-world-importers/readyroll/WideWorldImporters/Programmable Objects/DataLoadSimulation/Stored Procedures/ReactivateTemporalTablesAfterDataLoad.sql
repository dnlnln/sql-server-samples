IF OBJECT_ID('[DataLoadSimulation].[ReactivateTemporalTablesAfterDataLoad]') IS NOT NULL
	DROP PROCEDURE [DataLoadSimulation].[ReactivateTemporalTablesAfterDataLoad];
