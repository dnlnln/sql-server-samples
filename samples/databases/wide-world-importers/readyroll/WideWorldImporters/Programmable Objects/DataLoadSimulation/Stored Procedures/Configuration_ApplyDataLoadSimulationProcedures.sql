IF OBJECT_ID('[DataLoadSimulation].[Configuration_ApplyDataLoadSimulationProcedures]') IS NOT NULL
	DROP PROCEDURE [DataLoadSimulation].[Configuration_ApplyDataLoadSimulationProcedures];
