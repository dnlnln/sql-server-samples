IF OBJECT_ID('[DataLoadSimulation].[DeactivateTemporalTablesBeforeDataLoad]') IS NOT NULL
	DROP PROCEDURE [DataLoadSimulation].[DeactivateTemporalTablesBeforeDataLoad];
